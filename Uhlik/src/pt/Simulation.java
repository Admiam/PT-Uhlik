...
public class Simulation {
	...
	public static void main(String[] args){
		try(Scanner sc = new Scanner(System.in)){
			...
			System.out.println("Zadejte nazev vstupniho souboru BEZ pripony .txt");
			String file = sc.nextLine()+".txt";
			File in = new File("data/"+file);
			while(!in.exists()) {
				System.out.println("Chyba takovy soubor neni ve slozce data");
				System.out.println("Zadejte nazev vstupniho souboru BEZ pripony .txt");
				file = sc.nextLine()+".txt";
				in = new File("data/"+file);
			}
			input.setInput("data/"+file);
			input.read();
	...
	/**
	 * Metoda generujici kolecka
	 * @param distance potrebna vzdalenost kolecka
	 * @param volume potrebny objem kolecka
	 * @param deadline cas do doruceni
	 * @param timeW doba kterou to kolecku zabere
	 */
	...
	/**
	 * Metoda prohledavajici zasobnik skladu
	 * @param distance potrebna vzdalenost kolecka
	 * @param volume potrebny objem kolecka
	 * @param deadline cas do doruceni
	 * @param timeW doba kterou to kolecku zabere
	 * @return true pokud se naslo jinak false
	 */
	...
	/**
	 * Metoda vybirajici nejlepsi sklad
	 * @param current aktualni pozadavek
	 * @return true pokud se nasel jinak false
	 */
	...
	public static String stats() {
		String stats = ("Celkem obslouzeno pozadavku: "+totalSRequests+" a doruceno celkem "+totalBags+" pytlu.");
